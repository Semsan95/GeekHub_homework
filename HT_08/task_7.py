...
list_a = list(map(int, input('Введіть перший список через кому: ').split(',')))
list_b = list(map(int, input('Введіть другий список через кому: ').split(',')))
result = array_diff(list_a, list_b)
