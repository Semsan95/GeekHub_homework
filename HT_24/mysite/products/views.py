...
from products.tasks import fetch_products_task
...
def fetch(request):
    ...
    #     fetch_products_task.delay(product_id) - варіант з одночасним пошуком всіх продуктів, але сайт може заблокувати!
    fetch_products_task.delay(product_ids)
